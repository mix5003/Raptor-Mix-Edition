...
package dotnetgraphlibrary.dotnetgraph.Open_Graph_Window_Delegate_Type is
   ...
   function new_Open_Graph_Window_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_Open_Graph_Window_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end dotnetgraphlibrary.dotnetgraph.Open_Graph_Window_Delegate_Type;
pragma Import(MSIL,dotnetgraphlibrary.dotnetgraph.Open_Graph_Window_Delegate_Type,
   ".ver 2:0:0:0",
   "[dotnetgraph]dotnetgraphlibrary.dotnetgraph/Open_Graph_Window_Delegate_Type");
