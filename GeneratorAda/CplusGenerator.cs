...
{
    class CplusGenerator: generate_interface.typ, GeneratorAda.Imperative_Interface
    {
        ...
        public CplusGenerator()
        {
        }
        public CplusGenerator(string filename)
        {
            ...
            stream.WriteLine("#include <string>");
            stream.WriteLine();
