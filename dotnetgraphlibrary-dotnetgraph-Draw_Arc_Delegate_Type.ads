...
package dotnetgraphlibrary.dotnetgraph.Draw_Arc_Delegate_Type is
   ...
   function new_Draw_Arc_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_Draw_Arc_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end dotnetgraphlibrary.dotnetgraph.Draw_Arc_Delegate_Type;
pragma Import(MSIL,dotnetgraphlibrary.dotnetgraph.Draw_Arc_Delegate_Type,
   ".ver 2:0:0:0",
   "[dotnetgraph]dotnetgraphlibrary.dotnetgraph/Draw_Arc_Delegate_Type");
