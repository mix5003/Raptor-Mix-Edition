...
namespace NClass.GUI.Diagram
{
	public abstract partial class ListDialog : Form
	{
		...
		private void ItemSelected()
		{
			...
			btnAccept.Text = Strings.GetString("button_modify");
			lblItemCaption.Text = Strings.GetString("modify_item:");
		...
		private void ClearInput()
		{
			...
			btnAccept.Text = Strings.GetString("button_add_item");
			lblItemCaption.Text = Strings.GetString("add_new_item:");
			txtItem.Text = null;
		...
		private void UpdateTexts()
		{
			...
			lstItems.Columns[0].Text = Strings.GetString("item");
