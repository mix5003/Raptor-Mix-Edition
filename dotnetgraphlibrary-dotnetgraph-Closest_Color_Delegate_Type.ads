...
package dotnetgraphlibrary.dotnetgraph.Closest_Color_Delegate_Type is
   ...
   function new_Closest_Color_Delegate_Type(
      This : Ref := null;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return dotnetgraphlibrary.Color_Type.Valuetype;
   function Invoke(
      This : access Typ;
      red : Integer;
      green : Integer;
...
private
   ...
   pragma MSIL_Constructor(new_Closest_Color_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end dotnetgraphlibrary.dotnetgraph.Closest_Color_Delegate_Type;
pragma Import(MSIL,dotnetgraphlibrary.dotnetgraph.Closest_Color_Delegate_Type,
   ".ver 2:0:0:0",
   "[dotnetgraph]dotnetgraphlibrary.dotnetgraph/Closest_Color_Delegate_Type");
