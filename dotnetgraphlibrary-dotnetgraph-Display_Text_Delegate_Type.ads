...
package dotnetgraphlibrary.dotnetgraph.Display_Text_Delegate_Type is
   ...
   function new_Display_Text_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_Display_Text_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end dotnetgraphlibrary.dotnetgraph.Display_Text_Delegate_Type;
pragma Import(MSIL,dotnetgraphlibrary.dotnetgraph.Display_Text_Delegate_Type,
   ".ver 2:0:0:0",
   "[dotnetgraph]dotnetgraphlibrary.dotnetgraph/Display_Text_Delegate_Type");
