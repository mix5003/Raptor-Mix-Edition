...
namespace NClass.CSharp
{
	...
	public sealed class CSharpLanguage : DotNetLanguage
	{
		...
		static CSharpLanguage()
		{
			...
			validOperationModifiers = new Dictionary<OperationModifier, string>(6);
		...
		private static void ValidateOperationModifiers(Operation operation)
		{
			if (operation.IsStatic) {
				if (operation.IsVirtual) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "virtual", "static"));
				}
				if (operation.IsAbstract) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "abstract", "static"));
				}
				if (operation.IsOverride) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "override", "static"));
				}
				if (operation.IsSealed) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "sealed", "static"));
				}
			}
			...
			if (operation.IsVirtual) {
				if (operation.IsAbstract) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "abstract", "virtual"));
				}
				if (operation.IsOverride) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "override", "virtual"));
				}
				if (operation.IsSealed) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "sealed", "virtual"));
				}
			}
			...
			if (operation.IsHider) {
				if (operation.IsOverride) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "new", "override"));
				}
				if (operation.IsSealed) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "new", "sealed"));
				}
			}
			...
			if (operation.IsSealed) {
				if (operation.IsAbstract) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "sealed", "abstract"));
				}
				if (!operation.IsOverride)
		...
		private static void ValidateAccessModifiers(Operation operation)
		{
			...
			if (operation.Access == AccessModifier.Private) {
				if (operation.IsVirtual) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "private", "virtual"));
				}
				if (operation.IsAbstract) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "private", "abstract"));
				}
				if (operation.IsOverride) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "private", "override"));
				}
				if (operation.IsSealed) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "private", "sealed"));
				}
			}
		}
		...
		protected override void ValidateField(Field field)
		{
			if (field.IsConstant) {
				if (field.IsStatic) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "static", "const"));
				}
				if (field.IsReadonly) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "readonly", "const"));
				}
				if (field.IsVolatile) {
					throw new BadSyntaxException(
						Strings.GetString("error_invalid_modifier_combination", "volatile", "const"));
				}
			}
			if (field.IsReadonly && field.IsVolatile) {
				throw new BadSyntaxException(
					Strings.GetString("error_invalid_modifier_combination", "volatile", "readonly"));
			}
		}
		...
		/// </exception>
		protected override Operation Implement(CompositeType parent,
		...
		/// <paramref name="operation"/> is null.
		/// </exception>
		protected override Operation Override(Operation operation)
		{
			if (operation == null)
				throw new ArgumentNullException("operation");
				...
				operation.IsSealed)
			{
				throw new ArgumentException(
					Strings.GetString("error_cannot_override"), "operation");
			}
		...
		protected override StructureType CreateStruct()
		{
