...
namespace NClass.Java
{
	internal sealed class JavaConstructor : Constructor
	{
		...
		public sealed override string Name
		{
			...
			set
			{
				if (value != null && value != Parent.Name)
					throw new BadSyntaxException(Strings.GetString("error_constructor_name"));
			}
		}
		...
		public override bool IsStatic
		{
			...
			{
				if (value)
					throw new BadSyntaxException(Strings.GetString("error_cannot_set_static"));
			}
		}
		...
		public override bool IsSealed
		{
			...
			{
				if (value)
					throw new BadSyntaxException(Strings.GetString("error_cannot_set_modifier"));
			}
		}
				...
				if (match.Success) {
					try {
						...
						throw new BadSyntaxException(
							Strings.GetString("error_invalid_declaration"), ex);
					}
				}
				else {
