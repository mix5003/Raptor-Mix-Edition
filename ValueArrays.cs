...
namespace raptor
{
    ...
    public class Value_Array
    {
        ...
        public int[] get_Int32a()
        {
            ...
            for (int i = 0; i < row_count; i++)
            {
                result[i] = numbers_pkg.integer_of(
        ...
        public void set_Int32a(int[] values)
        {
            ...
            {
                this.Set_Value(numbers_pkg.make_value__3(i + 1),
                    numbers_pkg.make_value__3(values[i]));
            }
        }
        public void set_Singlea(float[] values)
        {
            ...
            {
                this.Set_Value(numbers_pkg.make_value__3(i + 1),
                    numbers_pkg.make_value__2(values[i]));
            }
        }
    ...
    public class Value_2D_Array
    {
        ...
        public int[][] get_Int32aa()
        {
            ...
            for (int i = 0; i < row_count; i++)
            {
                ...
                for (int j = 0; j < col_count; j++)
                {
                    result[i][j] = numbers_pkg.integer_of(
        ...
        public void set_Int32aa(int[][] values)
        {
            for (int i = values.Length - 1; i >= 0; i--)
            {
                ...
                {
                    this.Set_Value(numbers_pkg.make_value__3(i + 1),
                        numbers_pkg.make_value__3(j + 1),
                        numbers_pkg.make_value__3(values[i][j]));
                }
            }
        }
        public void set_Singleaa(float[][] values)
        {
            for (int i = values.Length - 1; i >= 0; i--)
            {
                for (int j = values[0].Length - 1; j >= 0; j--)
                {
                    this.Set_Value(numbers_pkg.make_value__3(i + 1),
                        numbers_pkg.make_value__3(j + 1),
                        numbers_pkg.make_value__2(values[i][j]));
                }
            }
        }
