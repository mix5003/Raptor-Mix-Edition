...
package dotnetgraphlibrary.dotnetgraph.Clear_Window_Delegate_Type is
   ...
   function new_Clear_Window_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_Clear_Window_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end dotnetgraphlibrary.dotnetgraph.Clear_Window_Delegate_Type;
pragma Import(MSIL,dotnetgraphlibrary.dotnetgraph.Clear_Window_Delegate_Type,
   ".ver 2:0:0:0",
   "[dotnetgraph]dotnetgraphlibrary.dotnetgraph/Clear_Window_Delegate_Type");
